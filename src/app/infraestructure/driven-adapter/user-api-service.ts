...
export class UserApiService {
  ...
  userLogin(userLoginRequestInterface: UserLoginRequestInterface): Observable<UserLoginResponseInterface>{
    return this.http.post<UserLoginResponseInterface>(this.BASE_URL+"/user/login", userLoginRequestInterface);
  }
  ...
  updateUser(userInterface: UserInterface): Observable<UserInterface>{
    return this.http.put<UserInterface>(this.BASE_URL+"/user/"+userInterface.userId, userInterface);
  }
